...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="data_produk.php" class="logo"><span class="lite">Admin</span></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="active" href="data_produk.php">Produk</a></li>
            </ul>
          </li>
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                <a class="btn btn-primary btn-lg" href="data_produk_tambah.php">Tambah Data</a>
                <div class="pull-right">
                  <form class="form-inline" method="GET" action="data_produk.php">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_heart"></i> Kategori</th>
...
if (!empty($search)) {
  $sql .= " WHERE produk.nama_produk LIKE '%$search%' OR kategori.nama_kategori LIKE '%$search%'";
}
...
<tr>
  ...
  <td>
    <div class="btn-group">
      <a class="btn btn-primary" href="data_produk_edit.php?id=<?php echo $data["id_produk"]; ?>"><i class="icon_pencil-edit_alt"></i></a>
      <a class="btn btn-danger" href="data_produk_hapus_db.php?id=<?php echo $data["id_produk"]; ?>"><i class="icon_close_alt2"></i></a>
    </div>
  </td>
</tr>
<?php } ?>
