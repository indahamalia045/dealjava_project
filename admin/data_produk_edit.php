...
<body>
  ...
  <section id="container" class="">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="data_produk.php">Produk</a></li>
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
    ...
    // Mendapatkan id produk yang akan diedit
    $id_produk = $_GET['id'];
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <form role="form" action="data_produk_edit_db.php" method="POST" enctype="multipart/form-data">
    ...
    <select name="kategori" class="form-control" id="kategori">
        <?php
            ...
            while ($data = mysqli_fetch_array($query)) {
                $selected = ($data_produk['kategori'] == $data['id_kategori']) ? 'selected' : '';
